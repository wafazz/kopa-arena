...
class BookingController extends Controller
{
    ...
    {
        $bookings = Booking::with('facility.branch', 'matchOpponent')
        ...
        return view('bookings.index', compact('bookings', 'totalBookings', 'pendingCount', 'approvedCount', 'totalRevenue'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->match_parent_id) {
            ...
            return redirect()->route('bookings.index')->with('success', 'Successfully joined match as opponent.');
        }

        // Normal flow: check slot availability (for both normal and new match bookings)
