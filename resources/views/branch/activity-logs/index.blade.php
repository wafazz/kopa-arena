    ...
    <div class="col-md-12">
        <div class="au-card m-b-30">
            <div class="au-card-inner">
                <form method="GET" action="{{ route('branch.activity-logs.index') }}" class="row g-2 mb-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="{{ route('branch.activity-logs.index') }}" class="btn btn-sm btn-outline-secondary">Reset</a>
                    </div>
                </form>
            </div>
        </div>
