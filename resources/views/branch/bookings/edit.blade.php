        ...
        <div class="alert alert-info d-flex align-items-center mb-0">
            ...
            <div>
                ...
                @if($booking->matchOpponent)
                    ...
                    (<a href="{{ route('branch.bookings.edit', $booking->matchOpponent) }}">Edit opponent booking #{{ $booking->matchOpponent->id }}</a>)
                @elseif($booking->matchParent)
                    <br>Team A: <strong>{{ $booking->matchParent->customer_name }}</strong>
                    (<a href="{{ route('branch.bookings.edit', $booking->matchParent) }}">Edit parent booking #{{ $booking->matchParent->id }}</a>)
                @else
    ...
    <div class="col-lg-12">
        <div class="au-card m-b-30">
            <div class="au-card-inner">
                ...
                <form action="{{ route('branch.bookings.update', $booking) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="row">
