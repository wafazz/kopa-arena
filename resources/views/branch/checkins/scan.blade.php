...
<div class="row">
    <div class="col-md-12">
        <div class="overview-wrap">
            ...
            <a href="{{ route('branch.checkins.index') }}" class="au-btn au-btn-icon au-btn--blue">
    ...
    <div class="col-lg-6">
        <div class="au-card m-b-30">
            <div class="au-card-inner">
                ...
                <form action="#" method="GET" id="manual-form">
                    <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    scanner.render(function onScanSuccess(decodedText) {
        ...
        window.location.href = '{{ url("branch/checkins/verify") }}/' + token;
    });
