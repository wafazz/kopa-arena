...
<div class="row">
    <div class="col-md-12">
        <div class="overview-wrap">
            ...
            <a href="{{ route('branch.checkins.scan') }}" class="au-btn au-btn-icon au-btn--blue">
            ...
            <div class="au-card-inner">
                @if($error && !$booking)
                    ...
                    <div class="text-center">
                        <a href="{{ route('branch.checkins.scan') }}" class="au-btn au-btn--blue">
                ...
                @elseif($booking)
                    ...
                    <div class="text-center mt-4">
                        @if(!$error)
                        <form action="{{ route('branch.checkins.process') }}" method="POST" class="d-inline">
                            @csrf
                        ...
                        @endif
                        <a href="{{ route('branch.checkins.scan') }}" class="au-btn au-btn--blue ms-2">
                            <i class="fas fa-qrcode me-1"></i> Scan Another
                        </a>
                    </div>
                @endif
