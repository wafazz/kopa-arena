...
@section('title', 'Branch Dashboard - Kopa Arena')
...
<div class="row">
    <div class="col-md-12">
        <div class="overview-wrap">
            <h2 class="title-1">Branch Dashboard</h2>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-borderless table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="{{ route('branch.orders.show', $order) }}"><strong>{{ $order->order_number }}</strong></a></td>
    ...
    if (dashCalEl) {
        var dashCal = new FullCalendar.Calendar(dashCalEl, {
            ...
            events: function(info, successCallback, failureCallback) {
                ...
                fetch("{{ route('branch.dashboard.calendar-events') }}?" + params.toString())
