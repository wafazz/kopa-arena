...
<div class="row">
    <div class="col-md-12">
        <div class="overview-wrap">
            ...
            <a href="{{ route('branch.products.create') }}" class="au-btn au-btn-icon au-btn--blue">
            ...
            <table class="table table-borderless table-striped table-earning" data-datatable>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('branch.products.edit', $product) }}" class="btn btn-sm btn-outline-primary">Edit</a>
                            <form action="{{ route('branch.products.destroy', $product) }}" method="POST" class="d-inline" data-confirm-delete>
                                @csrf @method('DELETE')
