...
<div class="row">
    <div class="col-md-12">
        <div class="overview-wrap">
            ...
            <a href="{{ route('close-sales.walkin.create', ['branch_id' => $branchId]) }}" class="au-btn au-btn-icon au-btn--green">
    ...
    <div class="col-md-12">
        <div class="au-card m-b-30">
            <div class="au-card-inner">
                <form method="GET" action="{{ route('close-sales.index') }}" class="row align-items-end">
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="alert alert-success d-flex justify-content-between align-items-center">
            ...
            <form action="{{ route('close-sales.reopen', $closeSale) }}" method="POST" class="d-inline" id="reopenForm">
                @csrf
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <form action="{{ route('close-sales.mark-paid', $booking) }}" method="POST" class="d-inline">
                                @csrf
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <form action="{{ route('close-sales.mark-order-paid', $order) }}" method="POST" class="d-inline">
                                @csrf
                                <button class="btn btn-sm btn-success" title="Mark as Paid"><i class="fas fa-check-double"></i> Mark Paid</button>
                            </form>
...
<div class="row m-b-30">
    <div class="col-md-12 text-center">
        <form action="{{ route('close-sales.close') }}" method="POST" id="closeDayForm">
            @csrf
