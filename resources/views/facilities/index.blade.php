...
<div class="row">
    <div class="col-md-12">
        <div class="overview-wrap">
            ...
            <a href="{{ route('facilities.create') }}" class="au-btn au-btn-icon au-btn--blue">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('facilities.destroy', $facility) }}" method="POST" class="d-inline" data-confirm-delete>
                                @csrf @method('DELETE')
